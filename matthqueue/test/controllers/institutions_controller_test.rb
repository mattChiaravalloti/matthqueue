...
class InstitutionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create institution" do
    assert_difference('Institution.count') do
      post institutions_url, params: { institution: { email_regex: @institution.email_regex, name: @institution.name, password: @institution.password, secret: @institution.secret } }
    end
  ...
  test "should update institution" do
    patch institution_url(@institution), params: { institution: { email_regex: @institution.email_regex, name: @institution.name, password: @institution.password, secret: @institution.secret } }
